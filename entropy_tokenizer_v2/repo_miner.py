...
def mine_repo(
    ...
    if verbose:
        print("[repo_miner] Stage 1 - mining Multi-line Block patterns ...")
    # Using the new multi-line block mining
    ...
    # build_replacement_map now produces stable <VAR_0>, <STR_1> etc.
