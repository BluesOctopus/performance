...
from offline_diagnostics import apply_stage1_only, apply_stage2_only, build_stage_repo_config, build_token_ledger, load_chunks, resolve_encoder_for_name
...
def main() -> int:
    ...
    with output_path.open("w", encoding="utf-8", newline="\n") as handle:
        for index, chunk in enumerate(chunks[: args.limit]):
